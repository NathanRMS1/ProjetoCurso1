...
--
-- Máquina: localhost
-- Data de Criação: 17-Dez-2016 às 20:33
...
(5, 'img/produtos/not_defined.png', 'Monitor', 'LG', 'LED 25" Full HD Widescreen - 2 HDMI', 1199, 0, 'A Vista', 'Seja para jogos ou para trabalhar, o monitor 25UM58 Ultrawide LG é perfeito para você. Com funções que facilitam a sua vida, você vai se apaixonar pela nova tela 21:9 IPS da LG, otimizado com Flicker Safe e Reader Mode para sua conveniência. Ideal para quem busca otimizar seu tempo com uma super tela multitarefas. E para os Gamers ainda conta com algumas funcionalidades como DAS, Game Mode e Black Stabilizer.', 50);
