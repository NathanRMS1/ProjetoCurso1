<article class="conteudo" style="margin-bottom:10px">
    <div class="col-md-10 col-md-push-1">
        ...
        <?php if($produtoBuscado['qtd_estoque']>0 && isset($_SESSION['kolosus']['nome'])){?><a href="?url=carrinhoCompras&Produto=<?php echo $produtoBuscado['id']?>" class="AddCarrinho"><button type="button" class="btn btn-warning">Comprar</button></a><?php }?>
