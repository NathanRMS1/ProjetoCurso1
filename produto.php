...
<div class="imgInfoProduto">
    <article class="Produto_um">
        ...
        <?php
                    ...
                    ?>
                        <a href="index.php" class="btn btn-info">Voltar a pagina inicial</a>
                    <?php
                    }else{
                    ?>
                        <a href="?url=login" class="btn btn-info">Clique aqui para fazer login</a>
                    <?php
                    }
                }
            }else{
        ?>
            <?php if($dadosProduto['qtd_estoque']>0 && isset($_SESSION['kolosus']['nome'])){?><a href="index.php?url=carrinhoCompras&Produto=<?php echo $dadosProduto['id']?>&car=<?php echo $_GET['car']?>" type="button" class="btn btn-danger">Finalizar Compra</a><?php }else{ ?>
            <a href="index.php" class="btn btn-info">Voltar a pagina inicial</a>
        <?php
                }
            }
